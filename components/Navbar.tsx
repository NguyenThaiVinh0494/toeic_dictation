...
export default function Navbar({ profile }: NavbarProps) {
  ...
  const navLinks = [
    ...
    ...(profile?.role === "admin" ? [{ name: "Quản trị", href: "/admin" }] : []),
  ];
            ...
            {profile ? (
              <div className="flex items-center gap-3">
                <div
                  ...
                  className="flex items-center gap-1.5 bg-slate-50 hover:bg-slate-100/80 transition-colors px-2.5 py-1 rounded-full border border-slate-100 cursor-pointer"
